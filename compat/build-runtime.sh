...
# Chocolatey is a native Windows process under Wine. Invoke it directly at the
# producer boundary rather than nesting it under PowerShell, where Wine reports
# an unusable -1 child status despite successful managed PowerShell execution.
choco_win='C:\ProgramData\chocolatey\bin\choco.exe'
mark_stage disable-chocolatey-powershell-host
trap - ERR
set +e
...
keys = [
    ...
    "featurePolicyStatusCommand", "featurePolicyStatusSettle",
